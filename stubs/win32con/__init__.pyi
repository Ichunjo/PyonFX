...
CF_SCREENFONTS = 1
CF_PRINTERFONTS = 2
type CF_BOTH = CF_SCREENFONTS | CF_PRINTERFONTS
CF_SHOWHELP = 4
CF_ENABLEHOOK = 8
...
WVR_HREDRAW = 256
WVR_VREDRAW = 512
type WVR_REDRAW = WVR_HREDRAW | WVR_VREDRAW
WVR_VALIDRECTS = 1024
MK_LBUTTON = 1
MK_RBUTTON = 2
MK_SHIFT = 4
...
type WS_OVERLAPPEDWINDOW = WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_THICKFRAME | WS_MINIMIZEBOX | WS_MAXIMIZEBOX
type WS_POPUPWINDOW = WS_POPUP | WS_BORDER | WS_SYSMENU
...
type WS_EX_OVERLAPPEDWINDOW = WS_EX_WINDOWEDGE | WS_EX_CLIENTEDGE
type WS_EX_PALETTEWINDOW = WS_EX_WINDOWEDGE | WS_EX_TOOLWINDOW | WS_EX_TOPMOST
...
# BDR_RAISED = 0x0005
# BDR_SUNKEN = 0x000a
type EDGE_RAISED = BDR_RAISEDOUTER | BDR_RAISEDINNER
type EDGE_SUNKEN = BDR_SUNKENOUTER | BDR_SUNKENINNER
type EDGE_ETCHED = BDR_SUNKENOUTER | BDR_RAISEDINNER
type EDGE_BUMP = BDR_RAISEDOUTER | BDR_SUNKENINNER
...
FLASHW_CAPTION = 1
FLASHW_TRAY = 2
type FLASHW_ALL = FLASHW_CAPTION | FLASHW_TRAY
FLASHW_TIMER = 4
FLASHW_TIMERNOFG = 12
...
LBS_NODATA = 8192
LBS_NOSEL = 16384
type LBS_STANDARD = LBS_NOTIFY | LBS_SORT | WS_VSCROLL | WS_BORDER
CB_OKAY = 0
CB_ERR = -1
CB_ERRSPACE = -2
CBN_ERRSPACE = -1
...
SIF_TRACKPOS = 16
type SIF_ALL = SIF_RANGE | SIF_PAGE | SIF_POS | SIF_TRACKPOS
...
type SERVICE_DRIVER = SERVICE_KERNEL_DRIVER | SERVICE_FILE_SYSTEM_DRIVER | SERVICE_RECOGNIZER_DRIVER
SERVICE_WIN32_OWN_PROCESS = 16
SERVICE_WIN32_SHARE_PROCESS = 32
type SERVICE_WIN32 = SERVICE_WIN32_OWN_PROCESS | SERVICE_WIN32_SHARE_PROCESS
SERVICE_INTERACTIVE_PROCESS = 256
type SERVICE_TYPE_ALL = SERVICE_WIN32 | SERVICE_ADAPTER | SERVICE_DRIVER | SERVICE_INTERACTIVE_PROCESS
...
CONTEXT_INTEGER = ...
type CONTEXT_FULL = CONTEXT_CONTROL | CONTEXT_FLOATING_POINT | CONTEXT_INTEGER
...
type TOKEN_READ = STANDARD_RIGHTS_READ | TOKEN_QUERY
type TOKEN_WRITE = STANDARD_RIGHTS_WRITE | TOKEN_ADJUST_PRIVILEGES | TOKEN_ADJUST_GROUPS | TOKEN_ADJUST_DEFAULT
...
BF_RIGHT = 4
BF_BOTTOM = 8
type BF_TOPLEFT = BF_TOP | BF_LEFT
type BF_TOPRIGHT = BF_TOP | BF_RIGHT
type BF_BOTTOMLEFT = BF_BOTTOM | BF_LEFT
type BF_BOTTOMRIGHT = BF_BOTTOM | BF_RIGHT
type BF_RECT = BF_LEFT | BF_TOP | BF_RIGHT | BF_BOTTOM
BF_DIAGONAL = 16
type BF_DIAGONAL_ENDTOPRIGHT = BF_DIAGONAL | BF_TOP | BF_RIGHT
type BF_DIAGONAL_ENDTOPLEFT = BF_DIAGONAL | BF_TOP | BF_LEFT
type BF_DIAGONAL_ENDBOTTOMLEFT = BF_DIAGONAL | BF_BOTTOM | BF_LEFT
type BF_DIAGONAL_ENDBOTTOMRIGHT = BF_DIAGONAL | BF_BOTTOM | BF_RIGHT
BF_MIDDLE = 2048
BF_SOFT = 4096
BF_ADJUST = 8192
BF_FLAT = 16384
...
QS_SENDMESSAGE = 64
QS_HOTKEY = 128
type QS_MOUSE = QS_MOUSEMOVE | QS_MOUSEBUTTON
type QS_INPUT = QS_MOUSE | QS_KEY
type QS_ALLEVENTS = QS_INPUT | QS_POSTMESSAGE | QS_TIMER | QS_PAINT | QS_HOTKEY
type QS_ALLINPUT = QS_INPUT | QS_POSTMESSAGE | QS_TIMER | QS_PAINT | QS_HOTKEY | QS_SENDMESSAGE
...
LAYOUT_BTT = 2
LAYOUT_VBH = 4
type LAYOUT_ORIENTATIONMASK = LAYOUT_RTL | LAYOUT_BTT | LAYOUT_VBH
...
type DCB_SET = DCB_RESET | DCB_ACCUMULATE
DCB_ENABLE = 4
DCB_DISABLE = 8
META_SETBKCOLOR = 513
META_SETBKMODE = 258
...
type GHND = GMEM_MOVEABLE | GMEM_ZEROINIT
type GPTR = GMEM_FIXED | GMEM_ZEROINIT
...
type LHND = LMEM_MOVEABLE | LMEM_ZEROINIT
type LPTR = LMEM_FIXED | LMEM_ZEROINIT
