...
def AlphaBlend(
    ...
    WidthSrc: typing.Any,
    HeightSrc: typing.Any,
    blendFunction: win32typing.PyBLENDFUNCTION,
) -> None:
    """
...
def CreateBitmap(
    width: typing.Any, height: typing.Any, cPlanes: typing.Any, cBitsPerPixel: typing.Any, bitmap_bits: typing.Any
) -> win32typing.PyGdiHANDLE:
    """
        Creates a bitmap
...
def RedrawWindow(
    hWnd: int,
    rcUpdate: tuple[typing.Any, typing.Any, typing.Any, typing.Any],
...
def DrawText(
    hDC: typing.Any | int, String: typing.Any, nCount: typing.Any, Rect: win32typing.PyRECT, Format: typing.Any
) -> tuple[typing.Any, win32typing.PyRECT]:
    """
...
def ExtTextOut(
    ...
    _int1: typing.Any,
    _int2: typing.Any,
    rect: win32typing.PyRECT | None,
    string: typing.Any,
    _tuple: tuple[tuple[typing.Any, typing.Any], ...] | None = ...,
) -> typing.Any:
    """
        Writes text to a DC.
...
def GetPath(hdc: int) -> tuple[tuple[tuple[int, int], ...], tuple[int, ...]]:
    """
...
def GetSaveFileNameW(
    ...
    TemplateName: win32typing.PyResourceId = None,
...
def UpdateLayeredWindow(
    hwnd: int,
    arg: tuple[typing.Any, typing.Any, typing.Any, typing.Any],
    hdcDst: int = None,
...
def DrawTextW(
    hDC: int, String: str, Count: typing.Any, Rect: win32typing.PyRECT, Format: typing.Any
) -> tuple[typing.Any, win32typing.PyRECT]:
    """
