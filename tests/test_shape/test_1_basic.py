...
def test_map1() -> None:
    original = Shape.from_ass_string(
        "m 757.33 832 b 1216.67 1440.67 311.33 1967.33 760 1880 875.33 2140 2167.33 1332 2360 2042.67 3037.33 2083.33 2786.67 1428.67 3621.33 1632 l 3298.67 901.33 2792 1237.33 2600 944 2378.67 1306.67 2074.67 786.67 1770.67 1296 1637.33 765.33 1421.33 1272"
    )
    dest = Shape.from_ass_string(
        "m 1514.66 1664 b 1216.67 1440.67 207.553 1311.553 380 940 350.132 856 722.443 444 674.286 583.62 759.332 520.832 619.26 317.482 724.266 326.4 l 599.758 163.878 465.333 206.222 400 145.231 339.81 186.667 276.623 104.889 221.334 162 192.627 90.039 157.926 141.333"
    )
    var = 1
...
def test_move2() -> None:
    original = Shape.from_ass_string(
        "m 3636.335 1219.637 l 331.692 127.136 67.439 3781.479 1192.119 1322.969 2687.91 2197.805 -118.881 3049.314 -2758.659 -1776.605"
    )
    dest = Shape.from_ass_string(
        "m 3651.045 -776558.141 l 346.402 -777650.642 82.149 -773996.299 1206.829 -776454.809 2702.62 -775579.973 -104.171 -774728.464 -2743.949 -779554.383"
    )
...
def test_bounding1() -> None:
    original = Shape.from_ass_string("m -100.5 0 l 100 0 b 100 100 -100 100 -100.5 0 c")
    check.equal(tuple(tuple(p) for p in original.bounding), tuple(tuple(p) for p in (PC2D(-100.5, 0), PC2D(100, 100))))


def test_bounding2() -> None:
    original = Shape.from_ass_string("m 0 0 l 20 0 20 10 0 10")
    check.equal(tuple(tuple(p) for p in original.bounding), tuple(tuple(p) for p in (PC2D(0.0, 0.0), PC2D(20.0, 10.0))))
...
def test_shear1() -> None:
    original = Shape.from_ass_string(
        "m 576 1056 l 1000 1824 1788 1232 2000 1944 2500 1296 2480 1896 2904 936 b 2642 718 2230 918 2224 1296 2263 943 2053 797 1724 812 1500 1144 1368 1456 1160 1488 941 1547 1135 645 784 616"
    )
    dest = Shape.from_ass_string(
        "m 1315.2 940.8 l 2276.8 1624 2650.4 874.4 3360.8 1544 3407.2 796 3807.2 1400 3559.2 355.2 b 3144.6 189.6 2872.6 472 3131.2 851.2 2923.1 490.4 2610.9 386.4 2292.4 467.2 2300.8 844 2387.2 1182.4 2201.6 1256 2023.9 1358.8 1586.5 418 1215.2 459.2"
    )
...
def test_shear2() -> None:
    original = Shape.from_ass_string(
        "m 84.57 96 l 107.43 276.57 189.71 157.71 269.71 274.29 288 77.71 249.14 82.29 253.71 176 192 93.71 118.86 201.14 112 96"
    )
    dest = Shape.from_ass_string(
        "m 468.57 518.85 l 1213.71 813.72 820.55 1106.26 1366.87 1622.84 598.84 1517.71 578.3 1327.99 957.71 1444.55 566.84 1053.71 923.42 795.44 496 656"
    )
    original.shear(4, 5)
    original.round()
    check.equal(str(original), str(dest))
